...
public final class Config
{
	...
	public static void loadL24TeamConfig()
	{
		...
		try
		{
			...
			/** VIP color name **/
			VIP_NAME_COLOR_ENABLED = Boolean.parseBoolean(L24TeamSettings.getProperty("VIPNameColorEnabled", "False"));
			VIP_NAME_COLOR = Integer.decode("0x" + L24TeamSettings.getProperty("VIPColorName", "00FFFF"));
			VIP_TITLE_COLOR = Integer.decode("0x" + L24TeamSettings.getProperty("VIPTitleColor", "00FF00"));
			VIP_XPSP_RATE = Float.parseFloat(L24TeamSettings.getProperty("VIPXpSpRate", "1.5"));
			VIP_ADENA_RATE = Float.parseFloat(L24TeamSettings.getProperty("VIPAdenaRate", "1.5"));
			VIP_DROP_RATE = Float.parseFloat(L24TeamSettings.getProperty("VIPDropRate", "1.5"));
			VIP_SPOIL_RATE = Float.parseFloat(L24TeamSettings.getProperty("VIPSpoilRate", "1.5"));
			VIP_CUSTOM_ITEM = Boolean.parseBoolean(L24TeamSettings.getProperty("VIPCustomItem", "false"));
			VIP_ITEM_ID = Integer.parseInt(L24TeamSettings.getProperty("VIPItemID", "3836"));
			VIP_X_DAYS = Integer.parseInt(L24TeamSettings.getProperty("VIPXDays", "1"));
			...
			NOBLE_CUSTOM_ITEM_ID = Integer.parseInt(L24TeamSettings.getProperty("NoobleCustomItemId", "6673"));
			...
			MAX_DRIFT_RANGE = Integer.parseInt(L24TeamSettings.getProperty("MaxDriftRange", "300"));
			...
			SPAWN_CHRISTMAS_TREE = Boolean.parseBoolean(L24TeamSettings.getProperty("SpawnChristmasTree", "false"));
