...
public final class RequestExEnchantSkill extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((!player.isInsideRadius(trainer, L2NpcInstance.INTERACTION_DISTANCE, false, false) && !player.isGM()) || (player.getSkillLevel(skillId) >= skillLvl) || (player.getClassId().getId() < 88))
		{
			return;
		}
