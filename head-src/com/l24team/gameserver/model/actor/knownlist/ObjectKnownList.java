...
public class ObjectKnownList
{
	...
	public boolean addKnownObject(final L2Object object, final L2Character dropper)
	{
		...
		if (!Util.checkIfInRange(getDistanceToWatchObject(object), getActiveObject(), object, true) || ObjectData.get(ObjectHolder.class, activeObject).isDifferentWorld(object))
		{
			return false;
		}
