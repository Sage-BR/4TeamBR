...
import com.l24team.gameserver.model.holder.TimeStamp;
...
public class L2PcInstance extends L2PlayableInstance
{
	...
	public void startMovingTask()
	{
		synchronized (movingTaskDefined)
		{
			if (!movingTaskDefined || (isMoving() && isAttackingNow()))
			{
				return;
			}
	...
	public void sitDown()
	{
		...
		if ((isCastingNow() && !relax) || sittingTaskLaunched)
		{
			// just return
			return;
		}
	...
	{
		if ((inventory == null) || inventory.getAllItemsByItemId(item_id) == null || inventory.getAllItemsByItemId(item_id).length == 0)
		{
			return false;
		}
