package com.l24team.gameserver.model.zone.shape;

import com.l24team.gameserver.model.zone.L2ZoneShape;
...
public class ZoneCylinder extends L2ZoneShape
{
	...
	public boolean intersectsRectangle(final int ax1, final int ax2, final int ay1, final int ay2)
	{
		...
		if ((Math.pow(ax1 - zoneX, 2) + Math.pow(ay1 - zoneY, 2) < zoneRadS) || (Math.pow(ax1 - zoneX, 2) + Math.pow(ay2 - zoneY, 2) < zoneRadS) || (Math.pow(ax2 - zoneX, 2) + Math.pow(ay1 - zoneY, 2) < zoneRadS) || (Math.pow(ax2 - zoneX, 2) + Math.pow(ay2 - zoneY, 2) < zoneRadS))
		{
			return true;
		}
