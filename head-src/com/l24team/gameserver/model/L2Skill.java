...
/**
 * This class...
 * @authors ProGramMoS, eX1steam, 4TeamBR dev
...
public abstract class L2Skill
{
			...
			case TARGET_AREA_AIM_CORPSE:
			{
				...
				if (target != null && target.isDead() && target instanceof L2MonsterInstance)
				{
					if (activeChar instanceof L2Summon)
					{
						...
						{
							if ((creature == null) || !GeoData.getInstance().canSeeTarget(activeChar, creature) || (isOffensive() && L2Character.isInsidePeaceZone(activeChar, creature)))
							{
								continue;
							}
	...
	{
		if ((!(player instanceof L2PcInstance) && !(player instanceof L2Attackable) && !(player instanceof L2Summon)) || (funcTemplates == null))
		{
	...
	{
		if (isPassive() || (effectTemplates == null) || (effector != effected && effected.isInvul()))
		{
	...
	{
		if (isPassive() || (effectTemplatesSelf == null))
		{
			return emptyEffectSet;
		}
	...
	public boolean isAbnormalEffectByName(final int abnormalEffect)
	{
		...
		if (isPassive() || (effectTemplates == null))
		{
			return false;
		}
