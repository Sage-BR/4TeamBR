...
import com.l24team.gameserver.model.zone.shape.ZoneCuboid;
import com.l24team.gameserver.model.zone.shape.ZoneCylinder;
import com.l24team.gameserver.model.zone.shape.ZoneNPoly;
					...
					if ("list".equalsIgnoreCase(n.getNodeName()))
					{
						for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
						{
							if ("zone".equalsIgnoreCase(d.getNodeName()))
							{
								...
								try
								{
									newZone = Class.forName("com.l24team.gameserver.model.zone.type.L2" + zoneType);
