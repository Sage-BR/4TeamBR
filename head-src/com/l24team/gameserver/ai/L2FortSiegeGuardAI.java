...
public class L2FortSiegeGuardAI extends L2CharacterAI implements Runnable
{
	...
	private final void factionNotifyAndSupport()
	{
		...
		if (((L2NpcInstance) actor).getFactionId() == null || target == null || target.isInvul() || (Rnd.get(10) > 4))
		{
	...
	private void attackPrepare()
	{
		...
		if ((attackTarget instanceof L2PcInstance && sGuard.getFort().getSiege().checkIsDefender(((L2PcInstance) attackTarget).getClan())) || !GeoData.getInstance().canSeeTarget(actor, attackTarget))
		{
