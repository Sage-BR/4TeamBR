...
public class L2CharacterAI extends AbstractAI
{
	...
	{
		if ((target == null) || (getIntention() == AI_INTENTION_REST) || actor.isAllSkillsDisabled() || actor.isAfraid())
		{
	...
	{
		if ((getIntention() == AI_INTENTION_REST && skill.isMagic()) || (actor.isAllSkillsDisabled() && !skill.isPotion()))
		{
			// Cancel action client side by sending Server->Client packet ActionFailed to the L2PcInstance actor
			clientActionFailed();
			return;
	...
	{
		if ((getIntention() == AI_INTENTION_REST) || actor.isAllSkillsDisabled())
		{
			// Cancel action client side by sending Server->Client packet ActionFailed to the L2PcInstance actor
			clientActionFailed();
			return;
	...
	{
		if ((getIntention() == AI_INTENTION_REST) || actor.isAllSkillsDisabled() || actor.isImobilised() || actor.isRooted())
		{
			// Cancel action client side by sending Server->Client packet ActionFailed to the L2PcInstance actor
			clientActionFailed();
			return;
	...
	{
		if ((getIntention() == AI_INTENTION_REST) || actor.isAllSkillsDisabled() || actor.isCastingNow())
		{
			// Cancel action client side by sending Server->Client packet ActionFailed to the L2PcInstance actor
			clientActionFailed();
			return;
