...
public class L2SiegeGuardAI extends L2CharacterAI implements Runnable
{
	...
	private void attackPrepare()
	{
		...
		if ((attackTarget instanceof L2PcInstance && sGuard.getCastle().getSiege().checkIsDefender(((L2PcInstance) attackTarget).getClan())) || !GeoData.getInstance().canSeeTarget(actor, attackTarget))
		{
